...
RUN wget -nv https://raw.githubusercontent.com/ClubCedille/infra-ng/master/pxe-config.ign?token=AargQDpdqc48irDv8MUZAuWqw2NGRIQFks5cQ6lQwA%3D%3D -O /home/cedille/pxe-config.ign
